                        ...
                        <tr key={index} className='border-t border-borderColor'>
                            <td className='p-3 flex items-center gap-3'>
                                ...
                                <div className='max-md:hidden'>
                                    ...
                                    <p className='text-xs text-gray-500'>{car.seating_capacity} {car.model} • {car.transmission} </p>
                                </div>
                            </td>
                            ...
                            <td className='p-3 max-md:hidden'>
                                <span className={`px-2 py-1 rounded-full text-xs ${car.isAvailable ? 'bg-green-100 text-green-500' : 'bg-red-100 text-red-500' }`}>
